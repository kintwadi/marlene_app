...
public class GMailSender extends javax.mail.Authenticator {
    private final String MAIL_SERVER = "smtp.gmail.com";
    private final String SENDER = "antmabiala@gmail.com";
    private final String SENDER_PASSWORD ="@@Docinho132";
